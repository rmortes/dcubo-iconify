# Dcubo Iconify Material Design Light

[![style: very good analysis][very_good_analysis_badge]][very_good_analysis_link]
[![Powered by Mason](https://img.shields.io/endpoint?url=https%3A%2F%2Ftinyurl.com%2Fmason-badge)](https://github.com/felangel/mason)
[![License: MIT][license_badge]][license_link]

A collection of icons from the [Material Design Light][author_link] set for use with the [Dcubo Iconify][dcubo_iconify_link] package.

## Installation 💻

**❗ In order to start using Dcubo Iconify Material Design Light you must have the [Dart SDK][dart_install_link] installed on your machine.**
...
Then, install the `dcubo_iconify_mdi_light` package:
