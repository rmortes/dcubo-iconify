...
import 'package:dcubo_iconify_generator/src/command_runner.dart';
...
void main() {
  group('DcuboIconifyGeneratorCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late DcuboIconifyGeneratorCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = DcuboIconifyGeneratorCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = DcuboIconifyGeneratorCommandRunner();
